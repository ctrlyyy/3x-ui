...
```
bash <(curl -Ls https://raw.githubusercontent.com/ctrlyyy/3x-ui/master/install.sh)
```
...
```
VERSION=v2.4.5 && bash <(curl -Ls "https://raw.githubusercontent.com/ctrlyyy/3x-ui/$VERSION/install.sh") $VERSION
```
------------
